...
/**
 * Template file creator listener
 */
class RegisterTemplateFileCreatorListener implements IEventListener {
    ...
    public function handle(Event $event): void {
        ...
        $templateManager->registerTemplateFileCreator(function (): TemplateFileCreator {
            $wordTemplate = new TemplateFileCreator(Application::APP_ID, $this->trans->t("New document"), ".docx");
        ...
        $templateManager->registerTemplateFileCreator(function (): TemplateFileCreator {
            $cellTemplate = new TemplateFileCreator(Application::APP_ID, $this->trans->t("New spreadsheet"), ".xlsx");
        ...
        $templateManager->registerTemplateFileCreator(function (): TemplateFileCreator {
            $slideTemplate = new TemplateFileCreator(Application::APP_ID, $this->trans->t("New presentation"), ".pptx");

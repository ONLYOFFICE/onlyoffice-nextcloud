OC.L10N.register(
    ...
    "Review mode explanation": "Wyjaśnienie trybu recenzji",
    "Markup and balloons": "Poprawki i objaśnienia",
    "All changes (Editing)": "Wszystkie zmiany (Redagowanie)",
    "Only markup": "Tylko poprawki",
    "All changes (Editing), no balloons": "Wszystkie zmiany (Redagowanie), ukryj dymki",
    "All changes accepted (Preview)": "Wszystkie zmiany zostały zaakceptowane (Podgląd)",
    "All changes rejected (Preview)": "Wszystkie zmiany zostały odrzucone (Podgląd)",
    ...
    "Download": "Pobierz",
    "Original format": "Oryginalny format",
    ...
    "An HTTP or HTTPS address for ONLYOFFICE Docs is required.": "Adres HTTP lub HTTPS jest wymagany dla ONLYOFFICE Docs."
},

OC.L10N.register(
    ...
    "Review mode explanation": "Обяснение на режима на преглед",
    "Markup and balloons": "Промени и балони",
    "Only markup": "Само маркиране",
    "All changes (Editing)": "Всички промени (редактиране)",
    "All changes accepted (Preview)": "Всички промени са приети (Предварителен преглед)",
    "All changes rejected (Preview)": "Всички отхвърлени промени (Предварителен преглед)",
    "Final": "Последни",
    "Original": "Оригинални",
    "version": "версия",
    ...
    "Download": "Изтегли",
    "Original format": "Оригинален формат",

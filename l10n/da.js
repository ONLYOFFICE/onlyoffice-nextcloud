OC.L10N.register(
    ...
    "Review mode explanation": "Forklaring af gennemgangstilstand",
    "Markup and balloons": "Markup og balloner",
    "All changes (Editing)": "Alle ændringer (redigering)",
    "Only markup": "Kun opmærkning",
    "All changes (Editing), no balloons": "Alle ændringer (redigering), ingen balloner",
    "All changes accepted (Preview)": "Alle ændringer accepteret (Forhåndvisning)",
    "All changes rejected (Preview)": "Alle ændringer afvist (Forhåndvisning)",
    "Final": "Endelig",
    "Original": "Original",
    "version": "version",
    ...
    "Apply": "Anvend",
    "No users here": "Ingen brugere her",
    "Enable Custom permissions for users on the Sharing tab, ensuring Edit is turned on and Share is turned off": "Aktivér Brugerdefinerede tilladelser for brugere under fanen Deling, og sørg for, at Rediger er slået til, og Del er slået fra",
    "Share this file": "Del denne fil",
    "An HTTP or HTTPS address for ONLYOFFICE Docs is required.": "HTTP- eller HTTPS-adresse for ONLYOFFICE Docs er påkrævet."
},

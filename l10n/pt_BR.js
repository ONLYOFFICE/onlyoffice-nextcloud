OC.L10N.register(
    ...
    "Review mode explanation": "Explicação do modo de revisão",
    "Markup and balloons": "Marcação e balões",
    "All changes (Editing)": "Todas as alterações (Editando)",
    "Only markup": "Somente marcação",
    "All changes (Editing), no balloons": "Todas as alterações (Editando), não há balões",
    "All changes accepted (Preview)": "Todas as alterações aceitas (Pré-visualizar)",
    "All changes rejected (Preview)": "Todas as alterações rejeitadas (Pré-visualizar)",
    "Final": "Final",
    "Original": "Original",
    "version": "versão",
    ...
    "An HTTP or HTTPS address for ONLYOFFICE Docs is required.": "É necessário um endereço HTTP ou HTTPS para o ONLYOFFICE Docs."
},

OC.L10N.register(
    ...
    "Review mode explanation": "レビューモードの説明",
    "Markup and balloons": "マークアップとバルーン",
    "All changes (Editing)": "全ての変更点(編集)",
    "Only markup": "マークアップのみ",
    "All changes (Editing), no balloons": "全ての変更点(編集)、吹き出しなし",
    "All changes accepted (Preview)": "全ての変更点が承認されました(プレビュー)",
    "All changes rejected (Preview)": "全ての変更点が拒否されました(プレビュー)",
    "Final": "最終版",
    "Original": "オリジナル",
    "version": "バージョン",
    ...
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using ONLYOFFICE Docs.": "ONLYOFFICE Docsを使用して、Nextcloud内でテキストドキュメント、スプレッドシート、プレゼンテーション、PDFを編集・共同作業できます。",
    "Learn more": "詳細を見る",
    ...
    "To ensure the security of important parameters in ONLYOFFICE Docs requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\" target=\"_blank\">click here</a>.": "ONLYOFFICE Docsリクエストの重要なパラメータのセキュリティを確保するため、設定ページでシークレットキーを設定してください。詳細については、<a href=\"{url}\" target=\"_blank\">こちらをクリック</a>してください。",
    "Info": "情報",
    "Open": "開く",
    ...
    "Advanced permissions explanation": "高度な権限の説明",
    "Limit access permissions for files shared with Custom permissions (Edit enabled, Share disabled) or via a public link with edit permission:": "カスタム権限（編集有効、共有無効）または編集権限付き公開リンクで共有されたファイルのアクセス権限を制限します：",
    "Document": "ドキュメント",
    "Review/Comment": "レビュー/コメント",
    "Spreadsheet": "スプレッドシート",
    "Comment/Global filter": "コメント/グローバルフィルター",
    ...
    "An HTTP or HTTPS address for ONLYOFFICE Docs is required.": "ONLYOFFICE DocsにはHTTPまたはHTTPSアドレスが必要です"
},
"nplurals=1; plural=0;");

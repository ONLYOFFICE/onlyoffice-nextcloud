OC.L10N.register(
    ...
    "Not supported version" : "サポートされていないバージョンです",
    ...
    "The default application for opening the format": "以下のファイルフォーマットはクリックで開く",
    "Open the file for editing (due to format restrictions, the data might be lost when saving to the formats from the list below)" : "編集できるファイルフォーマット (フォーマットの制限により、以下のフォーマットで保存する時にデータが失われる可能性があります)",
    "View details" : "詳細表示",
    "Save" : "保存",
    ...
    "Display Chat menu button" : "チャットメニューボタンを表示",
    "Display the header more compact" : "ヘッダーをよりコンパクトに表示",
    "Display Feedback & Support menu button" : "フィードバックとサポートメニューボタンを表示",
    "Display Help menu button" : "ヘルプメニューボタンを表示",

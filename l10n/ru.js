OC.L10N.register(
    ...
    "Encryption App is enabled, the application cannot work. You can continue working with the application if you enable master key." : "Включено шифрование, приложение не может продолжить работу. Вы сможете работать с приложением, если будете использовать мастер ключ.",

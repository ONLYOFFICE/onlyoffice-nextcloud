OC.L10N.register(
    ...
    "To ensure the security of important parameters in ONLYOFFICE Docs requests, please set a Secret Key on the Settings page. To learn more, <a href=\"{url}\">click here</a>.": "Для обеспечения безопасности важных параметров в запросах ONLYOFFICE Docs, пожалуйста, установите секретный ключ на странице настроек. Чтобы узнать больше, перейдите по ссылке <a href=\"{url}\">click here</a>.",
    "Info": "Информация",
    "Open": "Открыть",

OC.L10N.register(
    ...
    "Review mode explanation": "Пояснение режима рецензирования",
    "Markup and balloons": "Исправления и выноски",
    "All changes (Editing)": "Все изменения (Редактирование)",
    "Only markup": "Только исправления",
    "All changes (Editing), no balloons": "Все изменения (Редактирование), выноски выключены",
    "All changes accepted (Preview)": "Все изменения приняты (Просмотр)",
    "All changes rejected (Preview)": "Все изменения отклонены (Просмотр)",
    ...
    "An HTTP or HTTPS address for ONLYOFFICE Docs is required.": "Для ONLYOFFICE Docs необходимо использовать HTTP- или HTTPS-адрес."
},

OC.L10N.register(
    ...
    "Review mode explanation": "Explicación del modo de revisión",
    "Markup and balloons": "Revisiones y globos",
    "All changes (Editing)": "Todos los cambios (Edición)",
    "Only markup": "Solo revisiones",
    "All changes (Editing), no balloons": "Todos los cambios (Edición), sin globos",
    "All changes accepted (Preview)": "Todos los cambios aceptados (Vista previa)",
    "All changes rejected (Preview)": "Todos los cambios rechazados (Vista previa)",
    "Final": "Final",
    "Original": "Original",
    "version": "versión",
    ...
    "Saving …": "Guardando …",
    "Failed to save common settings": "No se pudo guardar la configuración general",
    "Failed to save security settings": "No se pudo guardar la configuración de seguridad",
    "Apply": "Aplicar",
    "No users here": "No hay usuarios aquí",
    "Enable Custom permissions for users on the Sharing tab, ensuring Edit is turned on and Share is turned off": "Habilite los permisos personalizados para los usuarios en la pestaña Compartir, asegurándose de que Editar esté activado y Compartir esté desactivado",
    "Share this file": "Compartir este archivo",
    "An HTTP or HTTPS address for ONLYOFFICE Docs is required.": "Se requiere una dirección HTTP o HTTPS para ONLYOFFICE Docs."
},

OC.L10N.register(
    ...
    "ONLYOFFICE app is not configured. Please contact admin" : "L'application ONLYOFFICE n'est pas configuré. Veuillez contacter votre administrateur",
    ...
    "ONLYOFFICE cannot be reached. Please contact admin" : "ONLYOFFICE est indisponible. Veuillez contacter votre administrateur",
    ...
    "Review mode explanation": "Explication du mode de révision",
    "Markup and balloons": "Balisage et bulles",
    "All changes (Editing)": "Toutes les modifications (Modifier)",
    "Only markup": "Balisage uniquement",
    "All changes (Editing), no balloons": "Toutes les modifications (Modifier), pas de ballons",
    "All changes accepted (Preview)": "Toutes les modifications acceptées (Aperçu)",
    "All changes rejected (Preview)": "Toutes les modifications rejetées (Aperçu)",
    "Final": "Finale",
    "Original": "Original",
    "version": "version",
    ...
    "Welcome to ONLYOFFICE Docs!": "Bienvenue dans ONLYOFFICE Docs !",
    "Edit and collaborate on text documents, spreadsheets, presentations, and PDFs within Nextcloud using ONLYOFFICE Docs.": "Modifiez et collaborez sur des documents texte, des feuilles de calcul, des présentations et des fichiers PDF dans Nextcloud à l'aide de ONLYOFFICE Docs.",
    ...
    "Advanced permissions explanation": "Explication des autorisations avancées",
    "Limit access permissions for files shared with Custom permissions (Edit enabled, Share disabled) or via a public link with edit permission:": "Limitez les autorisations d'accès pour les fichiers partagés avec des autorisations personnalisées (modification activée, partage désactivé) ou via un lien public avec autorisation de modification :",
    "Document": "Document",
    "Review/Comment": "Révision/Commentaire",
    "Spreadsheet": "Feuille de calcul",
    "Comment/Global filter": "Commentaire/Filtre global",
    "Presentation": "Présentation",
    "Comment": "Commentaire",
    "PDF": "PDF",
    "Comment/Form filling": "Commentaire/Remplissage de formulaire",
    "Mailing is completed successfully": "L'envoi a été effectué avec succès",
    "Mailing is completed with some errors": "L'envoi s'est terminé avec quelques erreurs",
    "Files. Mailing is completed successfully": "Fichiers. L'envoi a été effectué avec succès",
    "Files. Mailing is completed with some errors.\n At least %1$s mail messages could not be sent. Please check the Mail module to review the reasons for the failure.": "Fichiers. L'envoi s'est terminé avec quelques erreurs.\n Au moins %1$s messages n'ont pas pu être envoyés. Veuillez consulter le module de messagerie pour examiner les raisons de l'échec.",
    ...
    "An HTTP or HTTPS address for ONLYOFFICE Docs is required.": "Une adresse HTTP ou HTTPS pour le ONLYOFFICE Docs est requise."
},

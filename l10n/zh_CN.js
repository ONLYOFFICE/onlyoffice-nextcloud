OC.L10N.register(
    ...
    "Review mode explanation": "审阅模式说明",
    "Markup and balloons": "标记和内容气球",
    "All changes (Editing)": "所有更改 (编辑中)",
    "Only markup": "仅标记",
    "All changes (Editing), no balloons": "所有更改 (编辑中)，不显示内容气球",
    "All changes accepted (Preview)": "同意所有更改 (预览)",
    "All changes rejected (Preview)": "否决所有更改 (预览)",
    "Final": "最终版",
    "Original": "原始版本",
    "version": "版本",
    ...
    "An HTTP or HTTPS address for ONLYOFFICE Docs is required.": "请使用HTTP或HTTPS地址连接ONLYOFFICE Docs。"
},
"nplurals=1; plural=0;");

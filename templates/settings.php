...
<div class="section section-onlyoffice section-onlyoffice-common <?php if (empty($_["documentserver"]) && !$_["demo"]["enabled"] || !$_["successful"]) { ?>onlyoffice-hide<?php } ?>">
    ...
    <p>
        <input type="checkbox" class="checkbox" id="onlyofficeFloatingVersion"
               <?php if ($_["floatingVersion"]) { ?>checked="checked"<?php } ?> />
        <label for="onlyofficeFloatingVersion"><?php p($l->t("Keep floating version when force saving")) ?></label>
    </p>
